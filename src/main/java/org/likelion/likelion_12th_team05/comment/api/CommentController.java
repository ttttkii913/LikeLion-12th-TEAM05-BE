...
public class CommentController {
    ...
    public ApiResponseTemplate<CurationInfoResDto> commentSave(@RequestBody @Valid CurationSaveReqDto commentSaveReqDto
            , Principal principal) {
        CurationInfoResDto commentInfoResDto = commentService.commentSave(commentSaveReqDto, principal);
